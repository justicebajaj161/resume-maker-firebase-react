...
to ensure this you will have the tranfer state globally which requires context (do not use redux in this project!!!)
to make sure your setIsAuthenticated function has been exposed to the window object in the authContext component . 

use this  if (window.Cypress) {
